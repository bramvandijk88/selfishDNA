...
extern int MaxTime;
extern int getSummary;
extern int changegene;
extern int switchmix;
extern int switchdif;
extern int invasion;
extern int invasionsmall;
extern int dumpfile;
extern int smutation;
...
void InitialMain(std::string);
int Display(int, TYPE2**,...);
int DrawSlide(TYPE2**,char *);
int DrawSlide2(char *, TYPE2**, ...);
...
void PlotArrays(double [], double [], double [], double [], std::string);       // PlotArrays added by Brem to plot multiple arrays in 4 subplots
